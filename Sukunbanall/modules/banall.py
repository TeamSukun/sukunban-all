    ...
    if bot_permission:
        async for member in app.get_chat_members(chat_id):       
            try:
                    ...
                    await msg.reply_text(f"ᴀʙ ᴅᴇᴋʜ ʙsᴅᴋ ᴋᴀɪsᴇ ɴᴀɴɢᴀ ᴋᴀʀᴋᴇ ɢᴀɴᴅ ᴍᴀʀᴛᴀ ʜᴜ ʙᴀᴍʙᴏᴏ ʟᴀᴀʏᴀ ʜᴜ ᴍɪʀᴄʜɪ ʟᴀɢᴀ ᴋᴇ ɢʜᴜsᴀ ᴅᴜɴɢᴀ  {member.user.mention}")                    
            except Exception:
                pass
    else:
        await msg.reply_text("ᴀʙᴇ ᴛᴜᴛɪʏᴇ ʙsᴅᴋ ʙᴀɴ ʀɪɢʜᴛs ᴋᴀʜᴀ ʜ ʙᴇ ʏᴀ ᴛᴏʜ ᴛᴜ sᴜᴅᴏ ᴜsᴇʀ ᴍᴇ ɴʜɪ ʜᴏɢᴀ ᴊᴏ ᴜɴɢʟɪ ᴋᴀʀ ʀʜᴀ ʜ")  

# Don't copy or import @TeamSukun
