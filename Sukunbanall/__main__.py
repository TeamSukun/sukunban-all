from Sukunbanall import app,START_IMG,BOT_USERNAME,BOT_NAME,LOG
...
━━━━━━━ [sᴜᴋᴜɴ](https://t.me/sukunupdates) ━━━━━━━
⍟ ᴛʜᴇ ᴍᴏsᴛ ᴩᴏᴡᴇʀғᴜʟ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ʙᴏᴛ
⍟ ɪ ʜᴀᴠᴇ sᴏᴍᴇ ɪɴᴛᴇʀᴇsᴛɪɴɢ ᴘʟᴜɢɪɴs ʏᴏᴜ sʜᴏᴜʟᴅ ᴛʀʏ ɪᴛ ʙʏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ᴛʜᴇ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ.
⍟ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ||@TeamSukun||
⍟ ᴀ ᴘʏʀᴏɢʀᴀᴍ ʙᴀsᴇᴅ ᴛᴇʟᴇɢʀᴀᴍ ʙᴏᴛ ᴛᴏ ʙᴀɴ,ᴜɴʙᴀɴ,ᴋɪᴄᴋ,ᴜɴᴍᴜᴛᴇ,ᴍᴜᴛᴇ ᴀʟʟ ᴍᴇᴍʙᴇʀs ɪɴ ᴀ ɢʀᴏᴜᴘ ɪɴ sʜᴏʀᴛ ᴛɪᴍᴇ.
━━━━━━━ [sᴜᴋᴜɴ](https://t.me/sukunsupports) ━━━━━━━ 

┏━━━•◦●◉✿ ❟❛❟ ✿◉●◦•━━━━┓
┣ ⍟ [ǫᴜɪᴢ ᴄʜᴀɴɴᴇʟ](https://t.me/TeamSukun) ⍟
┣ ⍟ [sᴜᴋᴜɴ ᴜᴘᴅᴀᴛᴇs](https://t.me/sukunupdates) ⍟
┣ ⍟ [sᴜᴋᴜɴ sᴜᴘᴘᴏʀᴛs](https://t.me/sukunsupports) ⍟
┗━━━•◦●◉✿ ❟❛❟ ✿◉●◦•━━━━┛
...
START_BUTTONS=InlineKeyboardMarkup (
      [
      [
         InlineKeyboardButton (text="🫣 ᴀᴅᴅ ᴋᴀʀ ʟᴏ ɴᴀ 🫣",url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
      ],
      [
         InlineKeyboardButton (text="🌻 ʜᴇʟᴘ 🌻",callback_data="help_back")
      ],
      [
         InlineKeyboardButton (text="🥀 ɢɪᴛʜᴜʙ 🥀",url="https://github.com/TeamSukun")
      ]
      ]
)

HELP_MSG="""
**ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ɪɴ
